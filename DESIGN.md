...
- Typography scale: `font.size.xs=12px`, `font.size.sm=13px`, `font.size.md=13.33px`, `font.size.lg=14px`, `font.size.xl=15px`, `font.size.2xl=16px`, `font.size.3xl=20px`, `font.size.4xl=32px`
- Color palette: `color.text.primary=#f7f8f8`, `color.text.secondary=#8a8f98`, `color.border.muted=#ffffff`, `color.text.inverse=#62666d`, `color.focus.ring=#000000`, `color.surface.raised=#08090a`, `color.surface.strong=#e5e5e6`
- Spacing scale: `space.1=1px`, `space.2=4px`, `space.3=5px`, `space.4=6px`, `space.5=8px`, `space.6=10px`, `space.7=12px`, `space.8=14px`
- Radius/shadow/motion tokens: `radius.xs=2px`, `radius.sm=4px`, `radius.md=6px`, `radius.lg=8px`, `radius.xl=12px`, `radius.2xl=50px`, `radius.step7=9999px` | `shadow.1=rgba(0, 0, 0, 0.03) 0px 1.2px 0px 0px`, `shadow.2=rgba(0, 0, 0, 0) 0px 8px 2px 0px, rgba(0, 0, 0, 0.01) 0px 5px 2px 0px, rgba(0, 0, 0, 0.04) 0px 3px 2px 0px, rgba(0, 0, 0, 0.07) 0px 1px 1px 0px, rgba(0, 0, 0, 0.08) 0px 0px 1px 0px`, `shadow.3=rgba(255, 255, 255, 0.03) 0px 0px 0px 1px inset, rgba(255, 255, 255, 0.04) 0px 1px 0px 0px inset, rgba(0, 0, 0, 0.6) 0px 0px 0px 1px, rgba(0, 0, 0, 0.1) 0px 4px 4px 0px`, `shadow.4=rgba(0, 0, 0, 0.2) 0px 0px 0px 1px` | `motion.duration.instant=100ms`, `motion.duration.fast=160ms`, `motion.duration.normal=200ms`
...
- Include known page component density: buttons (92), links (72), lists (12), navigation (11), inputs (5).
